  ...
  <h4>Costos del evento</h4>
    <div class="table-responsive">
      <table class="table table-striped table-bordered table-condensed table-hover">
        ...
        <tr>
          <td><input name="extra_movil" class="form-control" value="{{$evento_detalle[0]->gasto_movilizacion}}"></td>
          <td><input name="total_iva" class="form-control" value="{{$evento_detalle[0]->iva_por_pagar}}"></td>
          <td><input name="total_final" class="form-control" value="{{$evento_detalle[0]->monto_a_cobrar}}"></td>
        </tr>
      </table>
    </div>
  </div>
