...
var haber_sum = 0;
  ...
  function calc(i, z){
    ...
    document.getElementById('IVA_ingredientes').value = parseInt($('#costo_ingr_total').val() * 0.19);
...
<div class="row">
  ...
  <div class="col-lg-2 col-md-2 col-sm-3 col-xs-12">
    ...
    <div class="input-group">
      <span class="input-group-addon">$</span>
      <input class="form-control" readonly="readonly" name="IVA_ingredientes" id="IVA_ingredientes" value="{{round(($total * 0.19) + ($total_ingr_ext * 0.19))}}">
    </div>
  </div>
  <div class="col-lg-2 col-md-2 col-sm-3 col-xs-12">
