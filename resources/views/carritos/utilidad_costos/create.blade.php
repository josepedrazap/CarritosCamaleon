...
var haber_sum = 0;
  ...
  function calc(i, z){
    ...
    document.getElementById('Utilidad_final').value = Math.round(parseInt({{$eventos_detalle[0]->precio_evento}} - {{$eventos_detalle[0]->precio_evento / 1.19}} - $('#IVA_ajustado').val() - $('#costo_total_evento').val()));
