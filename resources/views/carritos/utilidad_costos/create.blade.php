...
var haber_sum = 0;
  ...
  function calc(i, z){
    ...
    var t = {{$eventos_detalle[0]->precio_evento}};
    ...
    document.getElementById('Utilidad_final').value = t - (parseInt(t_iva - $('#IVA_ingredientes').val())) - (parseInt(total) +  parseInt(total_3) + parseInt(total_2) + {{$eventos_detalle[0]->pago_cocineros}});
