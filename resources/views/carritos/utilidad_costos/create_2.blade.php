          ...
          <table class="table table-striped table-bordered table-condensed table-hover">
            ...
            <tr>
              ...
              <th>
                ...
                <input class="form-control" readonly="readonly" value="{{$ingr->precio_bruto}}" onkeyup="calc({{$i}}, 1)" id="precio_bruto_{{$i}}" name="precio_bruto_ingr[]">
              </th>
...
<div class="row">
  ...
  <div class="col-lg-2 col-md-2 col-sm-3 col-xs-3">
    ...
    <div class="input-group">
      <span class="input-group-addon">$</span>
      <input class="form-control" readonly="readonly" name="Utilidad_final" id="Utilidad_final" value="{{$eventos_detalle[0]->precio_evento - $eventos_detalle[0]->precio_evento * 0.19 + $total*0.19 - $total - $total_ext - $eventos_detalle[0]->pago_cocineros}}">
    </div>
  </div>
  <div class="col-lg-2 col-md-2 col-sm-3 col-xs-3">
    ...
    <div class="input-group">
      <span class="input-group-addon">$</span>
      <input class="form-control" readonly="readonly" id="porcentaje_utilidad" value="{{100*($eventos_detalle[0]->precio_evento - $eventos_detalle[0]->precio_evento * 0.19 + $total*0.19 - $total - $total_ext - $eventos_detalle[0]->pago_cocineros)/$eventos_detalle[0]->precio_evento}}">
    </div>
  </div>
</div>
<hr></hr>
