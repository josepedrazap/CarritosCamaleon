...
<div class="row">
  <div class="col-lg-8 col-md-8 col-sm-8">
    ...
    {!!Form::open(array('url'=>'carritos/proveedores','method'=>'POST','autocomplete'=>'off'))!!}
    {{Form::Token()}}
    ...
    <div class="row">
      ...
      <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
        ...
        <div class="input-group">
          ...
          <input type="tel" name="telefono" class="form-control" placeholder="569..." required>
        </div>
      </div>
      <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
        <div class="form-group">
      ...
      <div class="form-group">
        <a href=""><button class="btn btn-primary" type="submit">Agregar proveedor</button></a>
