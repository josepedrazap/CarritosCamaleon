...
aprobado = 1;
function iva_calc(){
  if($("#tipo_doc option:selected").text() != 'Factura exenta'){
    v1 = $("#monto").val();
...
{!!Form::open(array('url'=>'/carritos/ingresos/guardar','method'=>'GET','autocomplete'=>'off'))!!}
{{Form::Token()}}

<div class="hidden">
  <input name="id_evento_" value="-1" hidden>
</div>

<div class="row">
  <div class="col-lg-8 col-md-8 col-sm-8">
    <h3>Crear comprobante de ingreso</h3>
...
<div class="row">
  <div class="col-lg-3 col-md-3">
    ...
    <select class="form-control selectpicker" name="cliente" required data-live-search="true">
...
<div class="row">
  <div class="col-lg-3 col-md-3">
    ...
    <div class="input-group">
      ...
      <input name="valor_neto" class="form-control" id="monto" onkeyup="iva_calc()">
    </div>
  </div>
  <div class="col-lg-3 col-md-3">
    <label>Excento</label>
  ...
  <div class="col-lg-3 col-md-3">
    ...
    <div class="input-group">
      <span class="input-group-addon">$</span>
      <input name="valor_iva" class="form-control" id="total_iva">
    </div>
  </div>
  <div class="col-lg-3 col-md-3">
    ...
    <div class="input-group">
      <span class="input-group-addon">$</span>
      <input name="valor_total" id="total_final" class="form-control" id="total_final">
    </div>
  </div>
</div>
<hr></hr>
  ...
  <div class="panel panel-primary">
    <div class="panel-body">
      ...
      <div class="col-lg-2 col-sm-2 col-md-12 col-xs-12">
        <div class="form-group">
          <label>Haber</label>
          <input type="number" name="haber" id="haber" class="form-control" >
        </div>
      </div>
      <div class="col-lg-2 col-sm-2 col-md-12 col-xs-12">
        <div class="form-group">
...
<div class="row" id="save" hidden>
  <div class="col-lg-2 col-md-2 col-sm-3 col-xs-12">
    <div class="form-group">
      <a href=""><button class="btn btn-primary" type="submit">Crear</button></a>
    </div>
  </div>
</div>
